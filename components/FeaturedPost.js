        ...
        <article>
            <div className="flex -mx-4 lg:items-center items-start flex-wrap">
                <div className="px-4 lg:w-8/12 md:w-7/12 w-full">
                    <Link href="/detail">
                        <a>
                            <img src="/hero.png" className="rounded-xl w-full mb-4 md:mb-0" />
                        </a>
                    </Link>
                </div>
                <div className="lg:w-4/12 md:w-5/12 px-4 mb-4 w-full">
                    <InfoPost
                        category="UI Design"
                        ...
                        authorName="Lukman Hanif Akbari"
                        authorJob="UI Designer"
                    />
                </div>
            </div>
            <hr className="border-white/5 mt-10 md:hidden" />
        </article>
    );
}